...
import type { ReceiverState, ThemeName } from '../types'
...
export default function StatusBar({ deviceName, state, wsConnected, receiverIp, currentTheme, onThemeChange }: Props) {
